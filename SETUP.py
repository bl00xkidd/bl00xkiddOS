...
def definir_cor(cor):
    ...
    if sistema == "windows":
        # Cores no Windows (usando o comando 'color')
        if cor == "AZUL":
            os.system("color 1")  # Fundo azul, texto preto
        elif cor == "VERDE":
            os.system("color 2")  # Fundo verde, texto preto
        elif cor == "VERMELHO":
            os.system("color 4")  # Fundo vermelho, texto preto
    else:
        # Cores no Linux/macOS (usando códigos de escape ANSI)
        cores = {
            "AZUL": "\033[34m",
            "VERDE": "\033[32m",
            "VERMELHO": "\033[31m",
